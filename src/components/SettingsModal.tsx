              ...
              <div className="space-y-2">
                ...
                <div className="p-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="font-medium text-[#0F172A]">Gemini 3.1 Flash-Lite Engine</p>
                      <p className="text-[11px] text-[#76777D]">Active multimodal OCR & receipt parser</p>
                    </div>
                  </div>
